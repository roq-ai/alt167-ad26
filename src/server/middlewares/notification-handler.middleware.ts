...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'organization.update': {
    roles: ['owner', 'administrator', 'it-technician', 'sales-representative'],
  ...
  'role.update': {
    ...
    key: 'role-updated',
    tenantPath: ['organization', 'user', 'role'],
    userPath: [],
  },
  'role.delete': {
    roles: ['owner', 'administrator'],
...
const tenantRoles: string[] = ['owner', 'administrator', 'it-technician', 'sales-representative'];
